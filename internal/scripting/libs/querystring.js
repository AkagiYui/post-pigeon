...
function dew$12() {
  ...
  exports$22 = function(obj, sep, eq, name) {
    sep = sep || "&";
    eq = eq || "=";
    if (obj === null) {
      obj = void 0;
...
function dew2() {
  ...
  _dewExec2 = true;
  exports$12.decode = exports$12.parse = dew$22();
  exports$12.encode = exports$12.stringify = dew$12();
  return exports$12;
}
var exports$3, _dewExec$22, exports$22, _dewExec$12, exports$12, _dewExec2, exports4, decode, encode, parse, stringify;
...
init_buffer2();
init_process2();
var m = (init_querystring(), __toCommonJS(querystring_exports));
