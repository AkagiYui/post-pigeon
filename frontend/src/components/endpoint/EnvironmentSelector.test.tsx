...
describe("environment selector", () => {
  it("has a noninteractive empty state", () => {
    ...
    expect(screen.getByLabelText("environment.none")).toBeVisible()
  ...
  it("keeps a single environment expandable and editing never selects it", async () => {
    ...
    expect(tooltip).toHaveTextContent("https://dev.example")
    expect(tooltip).toHaveTextContent("endpoint.baseUrl.hint")
